...
declare const NodeRepr_createComposite: <T1>(kind: ((_1: {
    readonly children: NodeRepr_t[];
    readonly context: NodeRepr_renderContext;
    readonly props: NodeRepr_props;
}) => NodeRepr_t), props: T1, children: NodeRepr_t[]) => NodeRepr_t;
declare const renderWith: (renderer: Renderer_t, graphs: NodeRepr_t[]) => number[];
...
export { NodeRepr_t, createNode, stdlib as el, isNode, renderWith, resolve, stdlib, stepGarbageCollector };
